...
-setup the python envirrment and install the required libraries: 
```
python3 -m venv .venv
...
-The infered .VTP is saved in "Sample_inference". This folder includes the .msh, .VTP, and .msh for the unseen data. Unseen data is a new set of geometry 
